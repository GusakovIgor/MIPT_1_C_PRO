...
int main (int argc, const char* argv[])
{
    ...
    char* DATA = (char*) RAM + RAM_SIZE;
    char* VRAM = (char*) RAM + RAM_SIZE + DATA_SIZE;
    processor->registers[0] = RAM_SIZE + DATA_SIZE;
...
{
    ChangeFileExtension (file_name, ".bin");
...
double* RAM_Maker ()
{
    double* RAM = (double*) calloc (RAM_SIZE + DATA_SIZE + VRAM_SIZE, sizeof(char));
    return  RAM;
}
