...
#define RET(left)                                       \
    CreateNode (RET_TYPE, 0.0, left, NULL)
...
#define  VAR(left, right, value)                        \
    CreateNode (VAR_TYPE,  value, left, right)

#define MATH(left, right, value)                        \
    CreateNode (MATH_TYPE,  (double) value, left, right)

#define COND(left, right, value)                        \
    CreateNode (COND_TYPE,  (double) value, left, right)
...
#define SQRT(left, right)                                \
    CreateNode (MATH_TYPE, (double) OP_SQRT, left, right)
